...
class CFG:
    ...
    # TOKENIZER: str = "KosmosTokenizer.tokenize or autotokenizer"
    # DATASET_NAME: str = "EleutherAI/the_pile_deduplicated" #HuggingFaceM4/VQAv2
    DATASET_NAME: str = "uggingFaceM4/VQAv2"
